...
public class Nivel extends PApplet{
	...
	static final int Inicio2 = 6;// the player starts where this is placed
	...
	int[][] matriz= {{1,2,2,2,0,4,0,0,4,0,0,4,0,2,2},
					 {1,1,3,1,0,0,0,0,0,0,0,0,6,1,1},
					 {0,0,0,0,0,0,1,3,1,5,1,1,1,2,0},
					 {0,0,0,2,1,1,0,0,0,0,0,0,4,0,0},
					 {0,1,3,1,2,2,0,0,1,1,1,0,0,2,0},
	...
	public void cambiarTipo(PVector estaPos, int nuevoTipo) {
	    ...
	    matrizNivel[gridSpotY][gridSpotX] = nuevoTipo;
	  }
	  ...
	  void pintar() { 
		    for(int i=0;i<filas;i++) { 
		      for(int ii=0;ii<columnas;ii++) {
		        ...
		        if(matriz[i][ii] == Objeto) {
		        	app.image(m.coin,ii*Tamano,i*Tamano, 
			        		Tamano-1,Tamano-1);
		        }
		      }
		    }
